 ...
 *
 * @method     \AppBundle\Database\Model\UserRoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppBundle\Database\Model\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppBundle\\Database\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email, password, role FROM user WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query by a related \AppBundle\Database\Model\UserRole object
     *
     * @param \AppBundle\Database\Model\UserRole|ObjectCollection $userRole the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($userRole instanceof \AppBundle\Database\Model\UserRole) {
            return $this
            ...
            throw new PropelException('filterByUserRole() only accepts arguments of type \AppBundle\Database\Model\UserRole or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \AppBundle\Database\Model\UserRoleQuery A secondary query class using the current class as primary query
     */
    public function useUserRoleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUserRole($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserRole', '\AppBundle\Database\Model\UserRoleQuery');
    }
