...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Model\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\Database\Model\Base\UserRole object.
     */
     ...
     * @return $this|\AppBundle\Database\Model\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Model\\UserRole'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Model\UserRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Model\UserRole The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        ...
        //relation fk_user_role_1 to table user
        ...
        //relation fk_user_role_2 to table role
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Model\UserRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Model\UserRole Clone of current object.
     * @throws PropelException
     */
