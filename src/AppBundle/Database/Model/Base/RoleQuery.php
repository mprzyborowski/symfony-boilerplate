...
use AppBundle\Database\Model\Map\RoleTableMap;
...
abstract class RoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppBundle\Database\Model\Base\RoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppBundle\\Database\\Model\\Role', $modelAlias = null)
    {
