...
abstract class Role implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Model\\Map\\RoleTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\Database\Model\Base\Role object.
     */
     ...
     * @return $this|\AppBundle\Database\Model\Role The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Model\\Role'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Model\Role
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Model\Role The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Model\Role (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Model\Role Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUsers()
    {
        ...
        $this->collUsers->setModel('\AppBundle\Database\Model\User');
    }
