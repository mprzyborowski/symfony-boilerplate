...
use AppBundle\Database\Model\Role;
use AppBundle\Database\Model\RoleQuery;
...
class RoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Database.Model.Map.RoleTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\Database\\Model\\Role';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AppBundle.Database.Model.Role';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\Database\\Model\\Role');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('User', '\\AppBundle\\Database\\Model\\User', RelationMap::MANY_TO_MANY, array(), null, null, 'Users');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\Database\Model\Role) { // it's a model object
