...
use AppBundle\Database\Model\UserRole;
use AppBundle\Database\Model\UserRoleQuery;
...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Database.Model.Map.UserRoleTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\Database\\Model\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AppBundle.Database.Model.UserRole';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\Database\\Model\\UserRole');
    ...
    {
        $this->addRelation('User', '\\AppBundle\\Database\\Model\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
        ...
        $this->addRelation('Role', '\\AppBundle\\Database\\Model\\Role', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':role_id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \AppBundle\Database\Model\UserRole $obj A \AppBundle\Database\Model\UserRole object.
     ...
     *
     * @param mixed $value A \AppBundle\Database\Model\UserRole object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \AppBundle\Database\Model\UserRole) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \AppBundle\Database\Model\UserRole object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\Database\Model\UserRole) { // it's a model object
